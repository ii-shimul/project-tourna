...
const Join = () => {
	return (
		<div className="lg:flex items-center justify-between p-5 lg:p-0 lg:mt-0 mt-15">
			<div>
				<h1 className="bebas  text-7xl">Join the Sports Revolution</h1>
				<p className="liter font-semibold text-xl">
					Dive deeper into sports culture and secure your tickets or
					memberships today!
				</p>
